<template>
  <div class="feel-table-wrapper" ref="wrapper">
    <div :style="{ height, overflow: 'auto' }" ref="tableWrapper">
      <table class="feel-table" :class="{ bordered, compact, striped: striped }" ref="table">
        <thead>
          <tr>
            <th v-if="expendField" :style="{ width: '50px' }" class="feel-table-center"></th>
            <th v-if="checkable" :style="{ width: '50px' }" class="feel-table-center">
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.$scopedSlots.default) {
        ...
        let width2 =
          width + parseInt(paddingRight) + parseInt(paddingRight) + parseInt(borderLeft) + parseInt(borderRight) + 'px'
