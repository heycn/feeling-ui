<template>
  <div class="page" style="position: relative">
    ...
    <!--<f-table :data-source="dataSource" bordered :selected-items.sync="selected" :order-by.sync="orderBy"-->
    <!--@update:orderBy="x" :loading="loading" :height="400" expend-field="description" checkable>-->
    <!--<f-table-column text="姓名" field="name" :width="100">-->
    <!--<template slot-scope="props">-->
    <!--<a :href="`/users/${props.value}`">{{props.value}}</a>-->
    <!--</template>-->
    <!--</f-table-column>-->
    <!--<f-table-column text="分数" field="score"></f-table-column>-->
    <!--</f-table>-->
    <!--</div>-->

    <f-scroll style="width: 300px; height: 400px">
...
<script>
  ...
  import FTableColumn from './table-column'
  ...
  export default {
    name: 'demo',
    components: { FPager, FTable, FTableColumn, FScroll },
    data() {
      return {
        currentPage: 1,
        selected: [],
